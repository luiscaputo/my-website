    ...
    <div className="font-mono text-xs md:flex hidden flex-row items-center space-x-8 ">
      ...
      >
        <ReactScrollLink to="aboutSection" spy={true} smooth={true} offset={-100} duration={200}>
          &gt; 01. <span className="text-white hover:cursor-pointer hover:text-AAsecondary duration-300">Sobre mim</span>
        </ReactScrollLink>
      </motion.div>
      <motion.div
        initial={{
      ...
      >
        <ReactScrollLink to="WhereIhaveWorkedSection" spy={true} smooth={true} offset={-300} duration={200}>
          &gt; 02.{" "}
          <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Minhas Experiências</span>
        </ReactScrollLink>
      </motion.div>
      <motion.div
        initial={{
      ...
      >
        ...
        &gt; 03. <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Projectos</span>
      ...
      >
         ...
         &gt; 04. <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Fale Comigo</span>
        </ReactScrollLink>
      </motion.span>
      ...
      <motion.button
        ...
        // onClick={()=>{router.push("/luiscaputo.pdf")}}
