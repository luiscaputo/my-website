...
const IconsData = [
  { href: "https://github.com/luiscaputo", Icon: GithubIcon },
  { href: "https://www.linkedin.com/in/luis-caputo-584a3315a/", Icon: LinkedinIcon },
  { href: "https://www.instagram.com/luiscaputo.0/", Icon: InstagramIcon },
  { href: "https://www.youtube.com/@luiscaputo", Icon: YoutubeIcon },
];
    ...
    text-sm  space-y-2  "
        >
          ...
          <span className="text-xs flex flex-row items-center space-x-2 group-hover:text-AAsecondary">
            ...
            <span className="">Código Fonte - Github</span>
          </span>
        </div>
      </a>
    </div>
