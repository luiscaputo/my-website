  ...
  return (
      <div className={` ${props.className} bg-AAprimary flex flex-col justify-center items-center py-8 space-y-4 `}>
        ...
        <div className="flex flex-row space-x-8">
          <ClickableIcon
            href={"https://github.com/luiscaputo"}
            Icon={GithubIcon}
          />
          <ClickableIcon
            href={"https://www.linkedin.com/in/luis-caputo-584a3315a/"}
            Icon={LinkedinIcon}
          />
          <ClickableIcon
            href={"https://www.instagram.com/luiscaputo.0/"}
            Icon={InstagramIcon}
          />
          <ClickableIcon
            href={"https://www.youtube.com/c/luiscaputo"}
            Icon={YoutubeIcon}
          />
        </div>
    ...
    text-sm  space-y-2  "
          >
            <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
              Projetado & construído por Luís Caputo
            </span>
